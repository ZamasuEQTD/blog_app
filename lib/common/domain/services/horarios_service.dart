    ...
    if (difference.inDays.abs() >= 30) {
      ...
      if (months == 1) {
        return TiempoTranscurrido(
            diferencia: months, tipo: TiposTiempoTranscurrido.mes);
      }
      return TiempoTranscurrido(
          diferencia: months, tipo: TiposTiempoTranscurrido.meses);
    } else if (difference.inDays > 0) {
      return TiempoTranscurrido(
          diferencia: difference.inDays, tipo: TiposTiempoTranscurrido.dias);
      ...
      return const TiempoTranscurrido(
          diferencia: 0, tipo: TiposTiempoTranscurrido.segundos);
