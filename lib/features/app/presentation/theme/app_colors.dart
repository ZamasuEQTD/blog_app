...
class AppColors {
  ...
  static const Color surface = Color.fromRGBO(242, 242, 242, 1);
  ...
  static const Color tertiary = Color.fromRGBO(227, 227, 227, 1);

  static const Color onTertiary = Color.fromRGBO(115, 115, 115, 1);
}
