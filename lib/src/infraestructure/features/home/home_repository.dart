...
class HomeRepository extends IHomeRepository {
  ...
  Future<Either<Failure, List<PortadaHome>>> getPortadas() async {
    return Right([
      PortadaHome(id: "id", titulo: "titulo", categoria: "categoria", banderas: PortadaHomeBanderas(
        dadosActivados: false,
        esNuevo: false,
        idUnicoActivado: false,
        tieneEncuesta: false
      ), imagen: Spoileable(false,
      Imagen(NetworkMedia(
      ...
      Imagen(NetworkMedia(
        "https://preview.redd.it/evie-templeton-is-portraying-laura-in-sh2-remake-and-the-v0-mc2fhcpkwq3d1.jpg?width=1080&crop=smart&auto=webp&s=a19290370f885c41d28cd175d03da150db609696"
      ))), ultimoBump: DateTime.now()),PortadaHome(id: "id", titulo: "titulo", categoria: "categoria", banderas: PortadaHomeBanderas(
        dadosActivados: false,
        esNuevo: false,
        idUnicoActivado: false,
        tieneEncuesta: false
