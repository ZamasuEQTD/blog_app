...
class GetHomePortadasQueryHandler extends IQueryHandler<GetHomePortadasQuery, Either<Failure, List<PortadaDeHilo>>> {
  final IHilosRepository _hilosRepository;

  GetHomePortadasQueryHandler(this._hilosRepository);

  @override
  Future<Either<Failure, List<PortadaDeHilo>>> handle(GetHomePortadasQuery request) async {
    return _hilosRepository.getPortadasDeHilosHome(
      titulo: request.titulo,
      utlimoBump: request.utlimoBump,
